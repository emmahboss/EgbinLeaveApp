...
class Employee(models.Model):
    ...
    line_manager_staff_id = models.CharField(_('Line Manager ID Number'),max_length=10,null=True,blank=True)
    Name_of_relief_person = models.CharField(_('Delegation of Authority(DOA)'),max_length=10,null=True,blank=True)
    date_issued = models.DateField(_('Date Issued'),help_text='date staff id was issued',blank=False,null=True)
